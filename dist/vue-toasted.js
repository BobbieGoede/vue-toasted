...
var Toasted = function Toasted(_options) {
  ...
  */
	this.show = function (message, options) {
		if (_this.options.customNotifications && _this.options.customNotifications.show != null) {
			options = Object.assign(options, _this.options.customNotifications.show);
		}
  ...
  */
	this.success = function (message, options) {
		options = options || {};
		if (_this.options.customNotifications && _this.options.customNotifications.success != null) {
			options = Object.assign(options, _this.options.customNotifications.success);
		}
  ...
  */
	this.info = function (message, options) {
		options = options || {};
		if (_this.options.customNotifications && _this.options.customNotifications.info != null) {
			options = Object.assign(options, _this.options.customNotifications.info);
		}
		options.type = "info";
		return _show(_this, message, options);
	};
  ...
  */
	this.error = function (message, options) {
		options = options || {};
		if (_this.options.customNotifications && _this.options.customNotifications.error != null) {
			options = Object.assign(options, _this.options.customNotifications.error);
		}
		options.type = "error";
		return _show(_this, message, options);
	};
